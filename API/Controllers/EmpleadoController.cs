...
namespace API.Controllers
{
    public class EmpleadoController : BaseController
    {
        ...
        public async Task<ActionResult<IEnumerable<Empleado>>> Get(){
            var items = await _UnitOfWork.Empleados.GetAllAsync();
            return Ok(items);
        }
        ...
        public async Task<ActionResult<IEnumerable<Empleado>>> Get(int id){
            var item = await _UnitOfWork.Empleados.GetIdAsync(id);
            return Ok(item); 
        }
        ...
        public async Task<ActionResult<Empleado>> Post(EmpleadoDto itemDto){
            ...
            this._UnitOfWork.Empleados.Add(item);
        ...
        public async Task<ActionResult<Empleado>> Put(int id, [FromBody] Empleado item){
            ...
            _UnitOfWork.Empleados.Update(item);
            await _UnitOfWork.SaveAsync();
            return item;
        }
        [HttpDelete("{id}")]
        ...
        public async Task<ActionResult> Delete(int id){
            ...
            _UnitOfWork.Empleados.Remove(item);
            await _UnitOfWork.SaveAsync();
            return NoContent();
        }
    }
