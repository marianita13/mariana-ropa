...
namespace API.Controllers
{
    public class PaisController : BaseController
    {
        ...
        public async Task<ActionResult<IEnumerable<Pais>>> Get(){
            var items = await _UnitOfWork.Paises.GetAllAsync();
            return Ok(items);
        }
        ...
        public async Task<ActionResult<IEnumerable<Pais>>> Get(int id){
            var item = await _UnitOfWork.Paises.GetIdAsync(id);
            return Ok(item); 
        }
        ...
        public async Task<ActionResult<Pais>> Post(PaisDto itemDto){
            ...
            this._UnitOfWork.Paises.Add(item);
        ...
        public async Task<ActionResult<Pais>> Put(int id, [FromBody] Pais item){
            ...
            _UnitOfWork.Paises.Update(item);
            await _UnitOfWork.SaveAsync();
            return item;
        }
        [HttpDelete("{id}")]
        ...
        public async Task<ActionResult> Delete(int id){
            ...
            _UnitOfWork.Paises.Remove(item);
            await _UnitOfWork.SaveAsync();
            return NoContent();
        }
    }
